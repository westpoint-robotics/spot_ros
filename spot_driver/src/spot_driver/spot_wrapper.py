...
class SpotWrapper():
    ...
    def getLease(self):
        ...
        self._lease_keepalive = LeaseKeepAlive(self._lease_client, warnings=False, must_acquire=True, return_at_exit=True)
        self._lease = self._lease_client.lease_wallet.get_lease()
